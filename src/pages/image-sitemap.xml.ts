...
import { PAGE_IMAGES, COVER } from '../data/images';
...
export const GET: APIRoute = async ({ site }) => {
  ...
  /* Issue covers are collection data rather than page imports, so they are
     ...
     Only the issue page declares its cover now. Neither the archive nor the
     homepage renders one: both use IssueCard, which carries no image. A cover
     declared against either would point at a URL that appears on no page,
