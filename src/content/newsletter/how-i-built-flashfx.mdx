...
standfirst: "Four rebuilds, two years, and 8,000 users later. What it actually took, including the parts that did not work."
image: "../../assets/flashfx-animator-timeline-canvas.png"
imageAlt: "The FlashFX animator interface, showing the timeline and canvas"
# Held back: the body below is still FlashFX export-system documentation, not
# the founder narrative the title and standfirst promise. As one post among
# many that was a title mismatch; as issue 001 it is the flagship. Flip to
# false once the real piece is written.
draft: true
---
