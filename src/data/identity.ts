...
export const DEVLOG = {
   ...
   *  second copy of /devlog that grows every time an entry is added. One
   *  entry is one day, however many projects that day covers, so this is
   *  three days and stays three days as projects are added. */
  homepageLimit: 3,
} as const;
